package com.common.timeout.client.tools.timewheel.impl;

import com.common.timeout.client.tools.timewheel.TimerWheelService;
import com.common.timeout.client.tools.timewheel.vo.TimeWheel;
import com.common.timeout.client.tools.timewheel.vo.TimerTask;
import com.common.timeout.client.tools.timewheel.vo.TimerTaskEntry;
import com.common.timeout.client.tools.timewheel.vo.TimerTaskList;
...
public class TimerWheelServiceImpl implements TimerWheelService {
    ...
    public TimerWheelServiceImpl() {
        this.timeWheel = new TimeWheel(1, 40, System.currentTimeMillis(), delayQueue);
        //20ms推动一次时间轮运转
