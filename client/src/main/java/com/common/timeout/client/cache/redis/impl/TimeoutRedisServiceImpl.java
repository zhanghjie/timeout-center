package com.common.timeout.client.cache.redis.impl;


import com.common.timeout.client.cache.redis.RedisService;
import com.common.timeout.client.cache.redis.TimeoutRedisService;
...
@Service
@Slf4j
public class TimeoutRedisServiceImpl implements TimeoutRedisService {
